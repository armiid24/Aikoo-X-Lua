...
for i, menu in ipairs(menuData) do
    ...
    btn.BackgroundColor3 = i == selectedMenu and Color3.fromRGB(80, 60, 120) or Color3.fromRGB(40, 40, 60)
    btn.BackgroundTransparency = i == selectedMenu and 0.15 or 0.3
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        for j, child in ipairs(Sidebar:GetChildren()) do
            if child:IsA("TextButton") then
                child.BackgroundColor3 = j == selectedMenu and Color3.fromRGB(80, 60, 120) or Color3.fromRGB(40, 40, 60)
                child.BackgroundTransparency = j == selectedMenu and 0.15 or 0.3
            end
        end
        updateContent()
    end)
